...
<html lang="en">
                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-lg-8 col-xl-6">
                            ...
                            <?php
                                ...
                                echo  '<h2 class="fw-bolder">'. $_GET['theme']. '</h2>';
                                echo '</div>';
                                ?>
                                </div>
                        </div>
    ...
    $theme1 = $_GET['theme'];
    $sql = "SELECT Theme, ArtImage, Name FROM themes JOIN artwork ON themes.ThemeID = artwork.ThemeID JOIN artists ON artwork.ArtistID = artists.ArtistID WHERE Theme = '$theme1' ";
                ...
                <div class="col-lg-4 mb-5">
                            <div class="card h-100 shadow border-0">
                                ...
                                <div class="card-body p-4">
                                    <h5 class="card-title mb-3"><a href="aboutArtists.php?name=$artistName">$artistName</a></h5>
                                    <p class="lead fw-normal text-muted mb-0">$descrip</p>
                                </div>
                            </div>
                        </div>        
            HTML;
